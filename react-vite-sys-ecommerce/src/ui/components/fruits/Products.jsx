                ...
                <ul className="nav nav-pills d-inline-flex text-center mb-5">
                  <li className="nav-item">
                    <a
                      ...
                      data-bs-toggle="pill"
                      onClick={(event) => {
                        event.preventDefault(); // 링크 이동하는거 막기
                        ...
                        <div key={product.id} className="col-md-6 col-lg-4 col-xl-3">
                          <div className="rounded position-relative fruite-item">
                            <div className="fruite-img ratio ratio-4x3 overflow-hidden rounded-top ">
                              <img src={`${import.meta.env.VITE_REQUEST_URL}${product.image}`} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div
                            ...
                            <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                              ...
                              <div className="d-flex flex-column align-items-center justify-content-between flex-lg-wrap">
                                <p className="text-dark fs-5 fw-bold mb-2">${product.price}</p>
                                {/* dev_6_Fruit */}
                                <button onClick={() => addToCart(product)} className="btn border border-secondary rounded-pill px-3 text-primary">
